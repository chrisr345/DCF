...
if __name__ == '__main__':
    ...
    parser.add_argument('--t', '--ticker', help = 'pass a single ticker to do historical DCF', type = str, default = 'PCG')
    ...
    parser.add_argument('--apikey', help='API key for financialmodelingprep.com')
